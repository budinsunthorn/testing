...
import * as customerModel from '../models-village/customer'
...
import * as itemCategory from '../models-village/itemCategory'
import * as taxSetting from '../models-village/taxSetting'
import * as productModel from '../models-village/product'
import * as packageModel from '../models-village/package'
import * as orderModel from '../models-village/order'
import * as inventoryModel from '../models-village/inventory'
import * as orderItemModel from '../models-village/orderItem'
import * as metrcItemCategoryModel from '../models-village/metrcItemCategory'
import * as itemModel from '../models-village/item'
import * as drawerModel from '../models-village/drawer'
import * as transferModel from '../models-village/transfer'
import * as reportModel from '../models-village/report'
